...
bool operator==(const ::four_wheel_steering_msgs::FourWheelSteering_<ContainerAllocator1> & lhs, const ::four_wheel_steering_msgs::FourWheelSteering_<ContainerAllocator2> & rhs)
{
  return lhs.front_steering_angle == rhs.front_steering_angle &&
    lhs.rear_steering_angle == rhs.rear_steering_angle &&
    lhs.front_steering_angle_velocity == rhs.front_steering_angle_velocity &&
    lhs.rear_steering_angle_velocity == rhs.rear_steering_angle_velocity &&
    lhs.speed == rhs.speed &&
